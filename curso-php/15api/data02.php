...
// print_r($agora);
// echo '<br>';
echo $agora->format($formatoData1) . '<br>'; // o format não leva em consideração o locale
...
echo ($outraData === $dataFutura ? 'Igual' : 'Diferente') . '<br>'; // diferente porque são duas instâncias diferentes
